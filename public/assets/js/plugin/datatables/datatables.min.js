...
!(function (t) {
    ...
    function N(e, n, r) {
        ...
        if (n) {
            for (r === a && (r = !1), o = 0, i = n.length; o < i; o++) {
                for (
                    u[o] = n[o].slice(), u[o].nTr = n[o].nTr, l = f - 1;
                    0 <= l;
                    l--
                )
        ...
        if (-1 !== t.inArray(!1, n)) ft(e, !1);
            ...
            if (0 !== c.length)
                for (l = u ? e.aoData.length : f, u = u ? 0 : s; u < l; u++) {
                    ...
                    Nt(e, "aoRowCallback", null, [d, h._aData, r, u]),
                        n.push(d),
                        r++;
                }
            else
    ...
    function M(e) {
        ...
        for (
            var i, l, s, u, c, f, d = e.sDom.split(""), h = 0;
            h < d.length;
            h++
        ) {
            if (((i = null), "<" == (l = d[h]))) {
