  ...
  <section className="section-slide">
    <div className="wrap-slick1">
      <div className="slick1">
        <div className="item-slick1" style={{backgroundImage: 'url(/client/images/slide-01.jpg)'}}>
        ...
        <div className="item-slick1" style={{backgroundImage: 'url(/client/images/slide-02.jpg)'}}>
          <div className="container h-full">
            <div className="flex-col-l-m h-full p-t-100 p-b-30 respon5">
        ...
        <div className="item-slick1" style={{backgroundImage: 'url(/client/images/slide-03.jpg)'}}>
          <div className="container h-full">
            <div className="flex-col-l-m h-full p-t-100 p-b-30 respon5">
      ...
      <div className="row">
        <div className="col-md-6 col-xl-4 p-b-30 m-lr-auto">
          ...
          <div className="block1 wrap-pic-w">
            <img src="/client/images/banner-01.jpg" alt="IMG-BANNER" />
        ...
        <div className="col-md-6 col-xl-4 p-b-30 m-lr-auto">
          {/* Block1 */}
          <div className="block1 wrap-pic-w">
            <img src="/client/images/banner-02.jpg" alt="IMG-BANNER" />
            <a href="product.html" className="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
              <div className="block1-txt-child1 flex-col-l">
                <span className="block1-name ltext-102 trans-04 p-b-8">
                  Men
        ...
        <div className="col-md-6 col-xl-4 p-b-30 m-lr-auto">
          {/* Block1 */}
          <div className="block1 wrap-pic-w">
            <img src="/client/images/banner-03.jpg" alt="IMG-BANNER" />
            <a href="product.html" className="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
              <div className="block1-txt-child1 flex-col-l">
                <span className="block1-name ltext-102 trans-04 p-b-8">
                  Accessories
    ...
    <div className="container">
      ...
      <div className="row isotope-grid">
        <div className="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
          ...
          <div className="block2">
            <div className="block2-pic hov-img0">
              <img src="/client/images/product-01.jpg" alt="IMG-PRODUCT" />
            ...
            <div className="block2-txt flex-w flex-t p-t-14">
              ...
              <div className="block2-txt-child2 flex-r p-t-3">
                <a href="#" className="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
                  <img className="icon-heart1 dis-block trans-04" src="/client/images/icons/icon-heart-01.png" alt="ICON" />
                  <img className="icon-heart2 dis-block trans-04 ab-t-l" src="/client/images/icons/icon-heart-02.png" alt="ICON" />
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
          ...
          <div className="block2">
            <div className="block2-pic hov-img0">
              <img src="/client/images/product-02.jpg" alt="IMG-PRODUCT" />
              <a href="#" className="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
                Quick View
              </a>
            </div>
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
          ...
          <div className="block2">
            <div className="block2-pic hov-img0">
              <img src="/client/images/product-03.jpg" alt="IMG-PRODUCT" />
              <a href="#" className="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
                Quick View
              </a>
            </div>
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
          ...
          <div className="block2">
            <div className="block2-pic hov-img0">
              <img src="/client/images/product-04.jpg" alt="IMG-PRODUCT" />
              <a href="#" className="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
                Quick View
              </a>
            </div>
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
          ...
          <div className="block2">
            <div className="block2-pic hov-img0">
              <img src="/client/images/product-05.jpg" alt="IMG-PRODUCT" />
              <a href="#" className="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
                Quick View
              </a>
            </div>
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
          ...
          <div className="block2">
            <div className="block2-pic hov-img0">
              <img src="/client/images/product-06.jpg" alt="IMG-PRODUCT" />
              <a href="#" className="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
                Quick View
              </a>
            </div>
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
          ...
          <div className="block2">
            <div className="block2-pic hov-img0">
              <img src="/client/images/product-07.jpg" alt="IMG-PRODUCT" />
              <a href="#" className="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
                Quick View
              </a>
            </div>
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
          ...
          <div className="block2">
            <div className="block2-pic hov-img0">
              <img src="/client/images/product-08.jpg" alt="IMG-PRODUCT" />
              <a href="#" className="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
                Quick View
              </a>
            </div>
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
          ...
          <div className="block2">
            <div className="block2-pic hov-img0">
              <img src="/client/images/product-15.jpg" alt="IMG-PRODUCT" />
              <a href="#" className="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
                Quick View
              </a>
            </div>
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
          ...
          <div className="block2">
            <div className="block2-pic hov-img0">
              <img src="/client/images/product-16.jpg" alt="IMG-PRODUCT" />
              <a href="#" className="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
                Quick View
              </a>
            </div>
    ...
    <div className="container">
      ...
      <div className="p-t-40">
        ...
        <p className="stext-107 cl6 txt-center">
          ...
          Copyright © All rights reserved | Made with <i className="fa fa-heart-o" aria-hidden="true" /> by <a href="https://colorlib.com" target="_blank">Colorlib</a> &amp; distributed by <a href="https://themewagon.com" target="_blank">ThemeWagon</a>
          {/* Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. */}
        </p>
      </div>
    </div>
